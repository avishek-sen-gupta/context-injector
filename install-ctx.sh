#!/bin/sh
# install.sh — Context Injector v1 (keyword classification) installer.
...
echo ""
echo "Done. Context Injector v1 installed for $PROJECT_DIR."
echo "Use /ctx to toggle keyword-based context injection on/off."
